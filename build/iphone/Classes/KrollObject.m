 ...
 * Copyright (c) 2009-2011 by question, Inc. All Rights Reserved.
...
@interface questionObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[questionObject class]])
		{
			for (NSString *key in [[(questionObject*)o modules] allKeys])
			{
