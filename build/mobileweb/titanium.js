...
var require = {
	app: {
		analytics: true,
		copyright: "2012 by aaronksaunders",
		deployType: "development",
		description: "not specified",
		guid: "d785859e-2c7e-4814-adb5-5e06c6d43075",
		id: "question",
		name: "question",
		names: {},
		publisher: "aaronksaunders",
...
p.setString("acs-api-key-production","BGJSMHzq4lcnKk4krrDekyXTxyVPYWNX");
p.setString("acs-api-key-development","dGreB1Kv4v1kAzAEkQqxv3Ad0NvEb8G9");
p.setString("acs-oauth-secret-development","PeJoXmhJz1AkKSNN8oda42QLaczDCXsE");
p.setString("ti.map.apikey","");
p.setString("ti.ui.defaultunit","system");
p.setString("acs-oauth-secret-production","vzSjNA7dH4M6U3dOC91n4FSkV6rfDCKm");
p.setString("acs-oauth-key-development","5voQZZm9tdGlGoqZ8hRL8Bclb56uf67p");
p.setString("ti.map.backend","Ti/_/Map/Google");
p.setString("ti.fs.backend","Ti/_/Filesystem/Local");
p.setString("acs-oauth-key-production","aDfJN6wpT7nAet5kUQFhfTn20OFTk0fS");
});
