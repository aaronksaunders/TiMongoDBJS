...
/**
 The base class for all question modules
 */
...
/**
 question Platform calls this method on startup.
 */
-(void)startup;

/**
 question Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 question Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 question Platform calls this method on resume.
 @param sender The sender of the event.
 */
