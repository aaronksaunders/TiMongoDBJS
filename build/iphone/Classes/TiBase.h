...
// in simulator we redefine to format for question Developer console
...
{\
	NSString * exceptionName = [@"org.question." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.question";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIquestionNativeItemNone = -1, 
	UIquestionNativeItemSpinner = -2,
	UIquestionNativeItemProgressBar = -3,
	
	UIquestionNativeItemSlider = -4,
	UIquestionNativeItemSwitch = -5,
	UIquestionNativeItemMultiButton = -6,
	UIquestionNativeItemSegmented = -7,
	
	UIquestionNativeItemTextView = -8,
	UIquestionNativeItemTextField = -9,
	UIquestionNativeItemSearchBar = -10,
	
	UIquestionNativeItemPicker = -11,
	UIquestionNativeItemDatePicker = -12,
	
	UIquestionNativeItemInfoLight = -13,
	UIquestionNativeItemInfoDark = -14,
	
	UIquestionNativeItemDisclosure = -15,
	
	UIquestionNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all question instances of
